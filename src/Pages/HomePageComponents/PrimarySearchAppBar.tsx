...
export default function PrimarySearchAppBar() {
  ...
  //restore all Orders of user,if no order create one for user
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
            <IconButton aria-label="show 4 new mails" color="inherit">
              <Badge badgeContent={activeOrder ? activeOrder.orderItemsList.length : 0} color="secondary">
                <ShoppingCartIcon onClick={switchToShoppingCartPage} />
              </Badge>
            </IconButton>
