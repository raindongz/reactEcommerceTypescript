...
//address
    ...
    function AddressForm(props:addressProps) {
        ...
        function handleChange(e:ChangeEvent<HTMLInputElement>){
            ...
            props.callBackFromParent("default address");
        }
        return (
            <React.Fragment>
                <Typography variant="h6" gutterBottom>
    ...
    function Review() {
        ...
        const Total = ({ products }: any) => (
            <Typography variant="subtitle1" className={classes.total}>
                Total Price: $
                {activeOrder && activeOrder.orderItemsList? activeOrder.orderItemsList.reduce(
        ...
        return (
            <React.Fragment>
                ...
                <List disablePadding>
                    {activeOrder && activeOrder.orderItemsList ? activeOrder.orderItemsList.map((product) => (
                        <ListItem className={classes.listItem} key={product.productId}>
                            <ListItemText primary={product.productName} secondary={ `X ${product.quantity}`} />
                        ...
                        {activeStep === steps.length ? (
                            <React.Fragment>
                                ...
                                <Typography variant="subtitle1">
                                    Your order number is {activeOrder.id}. We have emailed your order confirmation, and will
